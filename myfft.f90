...
! ==================================================
! fft 1-dimension ----------------------------------
subroutine fft1d(type, fft_input)
  integer, intent(in) :: type
  complex(kind(0.d0)), intent(inout) :: fft_input(0:)
  complex(kind(0.d0)) :: fft_output(0:size(fft_input(0:)) -1)
  double precision :: fft_a(0:2*size(fft_input(0:)) -1), fft_w(0:size(fft_input(0:))/2 -1)
  integer :: fft_ip(0:size(fft_input(0:)) -1), i, n
  n = size(fft_input(0:))
  fft_a (:) = 0.d0
  fft_ip(0) = 0
  if(type == +1) then
    do i = -n/2 , -1
      fft_a(2*(n +i))    =  real(fft_input(n/2 +i))
      fft_a(2*(n +i) +1) = aimag(fft_input(n/2 +i))
    enddo
    do i = 0, n/2 -1
      fft_a(2*(i))       =  real(fft_input(n/2 +i))
      fft_a(2*(i)    +1) = aimag(fft_input(n/2 +i))
    enddo
  endif
  if(type == -1) then
    do i = -n/2 , n/2 -1
      fft_a(2*(n/2 +i))    =  real(fft_input(n/2 +i))
      fft_a(2*(n/2 +i) +1) = aimag(fft_input(n/2 +i))
    enddo
  endif
  call cdft(2*n, type, fft_a, fft_ip, fft_w)
  if(type == +1) then
    do i = -n/2 , n/2 -1
      fft_input(n/2 +i) &
        = cmplx(fft_a(2*(n/2 +i)), fft_a(2*(n/2 +i) +1), kind = 8)
    enddo
  endif
  if(type == -1) then
    do i = -n/2, -1
      fft_input(n/2 +i) &
        = cmplx(fft_a(2*(n +i)), fft_a(2*(n +i) +1), kind = 8)
    enddo
    do i = 0, n/2 -1
      fft_input(n/2 +i) &
...
! fft 2-dimension ----------------------------------
subroutine fft2d(type, fft_input)
  integer, intent(in) :: type
  complex(kind(0.d0)), intent(inout) :: fft_input(0:, 0:)
  complex(kind(0.d0)) :: fft_output(0:size(fft_input(0:, 0)) -1, 0:size(fft_input(0, 0:)) -1)
  double precision :: fft_a(0:2*size(fft_input(0:, 0)) -1, 0:size(fft_input(0, 0:)) -1)
  double precision :: fft_t(0:8*size(fft_input(0, 0:)) -1)
  double precision :: fft_w(0:max(size(fft_input(0:, 0))/2, size(fft_input(0, 0:))/2) -1)
  integer :: fft_ip(0:max(size(fft_input(0:, 0))/2, size(fft_input(0, 0:))/2) -1)
  integer :: i1, i2, n1, n2
  n1 = size(fft_input(0:, 0))
  n2 = size(fft_input(0, 0:))
  fft_a (:, :) = 0.d0
  fft_ip(0) = 0
  if(type == +1) then
    do i1 = -n1/2, -1
      ...
      do i2 = 0, n2/2 -1
        ...
        fft_a(2*(n1 +i1) +1, i2) = aimag(fft_input(n1/2 +i1, n2/2 +i2))
      enddo
    enddo
    do i1 = 0, n1/2 -1
      do i2 = -n2/2, -1
        fft_a(2*(i1), n2 +i2) = real(fft_input(n1/2 +i1, n2/2 +i2))
        fft_a(2*(i1) +1, n2 +i2) = aimag(fft_input(n1/2 +i1, n2/2 +i2))
      enddo
      do i2 = 0, n2/2 -1
        fft_a(2*(i1), i2) = real(fft_input(n1/2 +i1, n2/2 +i2))
        fft_a(2*(i1) +1, i2) = aimag(fft_input(n1/2 +i1, n2/2 +i2))
      enddo
    enddo
  endif
  if(type == -1) then
    do i1 = -n1/2, n1/2 -1
      do i2 = -n2/2, n2/2 -1
        fft_a(2*(n1/2 +i1), n2/2 +i2) = real(fft_input(n1/2 +i1, n2/2 +i2))
        fft_a(2*(n1/2 +i1) +1, n2/2 +i2) = aimag(fft_input(n1/2 +i1, n2/2 +i2))
      enddo
    enddo
  endif
  call cdft2d(2*n1, 2*n1, n2, type, fft_a, fft_t, fft_ip, fft_w)
  if(type == +1) then
    do i1 = -n1/2, n1/2 -1
      do i2 = -n2/2, n2/2 -1
        fft_input(n1/2 +i1, n2/2 +i2) &
          = cmplx(fft_a(2*(n1/2 +i1), n2/2 +i2), fft_a(2*(n1/2 +i1) +1, n2/2 +i2), kind = 8)
      enddo
    enddo
  endif
  if(type == -1) then
    do i1 = -n1/2, -1
      do i2 = -n2/2, -1
        fft_input(n1/2 +i1, n2/2 +i2) &
          = cmplx(fft_a(2*(n1 +i1), n2 +i2), fft_a(2*(n1 +i1) +1, n2 +i2), kind = 8)
      enddo
      do i2 = 0, n2/2 -1
        fft_input(n1/2 +i1, n2/2 +i2) &
          = cmplx(fft_a(2*(n1 +i1), i2), fft_a(2*(n1 +i1) +1, i2), kind = 8)
      enddo
    enddo
    do i1 = 0, n1/2 -1
      do i2 = -n2/2, -1
        fft_input(n1/2 +i1, n2/2 +i2) &
          = cmplx(fft_a(2*(i1), n2 +i2), fft_a(2*(i1) +1, n2 +i2), kind = 8)
      enddo
      do i2 = 0, n2/2 -1
        fft_input(n1/2 +i1, n2/2 +i2) &
          = cmplx(fft_a(2*(i1), i2), fft_a(2*(i1) +1, i2), kind = 8)
      enddo
    enddo
  endif
  fft_input(:, :) = fft_input(:, :)/dble(n1*n2)**0.5d0
end subroutine fft2d
! fft 3-dimension ----------------------------------
subroutine fft3d(type, fft_input)
  integer, intent(in) :: type
  complex(kind(0.d0)), intent(inout) :: fft_input(0:, 0:, 0:)
  complex(kind(0.d0)) :: fft_output(0:size(fft_input(0:, 0, 0)) -1, 0:size(fft_input(0, 0:, 0)) -1, 0:size(fft_input(0, 0, 0:)) -1)
  double precision :: fft_a(0:2*size(fft_input(0:, 0, 0)) -1, 0:size(fft_input(0, 0:, 0)) -1, 0:size(fft_input(0, 0, 0:)) -1)
  double precision :: fft_t(0:8*max(size(fft_input(0, 0:, 0)), size(fft_input(0, 0, 0:))) -1)
  double precision :: fft_w(0:max(size(fft_input(0:, 0, 0)), size(fft_input(0, 0:, 0)), size(fft_input(0, 0, 0:))) -1)
  integer :: fft_ip(0:max(size(fft_input(0:, 0, 0)), size(fft_input(0, 0:, 0)), size(fft_input(0, 0, 0:)))/2 -1)
  integer :: i1, i2, i3, n1, n2, n3
  n1 = size(fft_input(0:, 0, 0))
  n2 = size(fft_input(0, 0:, 0))
  n3 = size(fft_input(0, 0, 0:))
  fft_a (:, :, :) = 0.d0
  fft_ip(0) = 0
  if(type == +1) then
    do i1 = -n1/2, -1
      ...
      do i2 = 0, n2/2 -1
        ...
        do i3 = 0, n3/2 -1
          ...
          fft_a(2*(n1 +i1) +1, i2, i3) = aimag(fft_input(n1/2 +i1, n2/2 +i2, i3))
        enddo
      enddo
    enddo
    do i1 = 0, n1/2 -1
      do i2 = -n2/2, -1
        ...
        do i3 = 0, n3/2 -1
          ...
          fft_a(2*(i1) +1, n2 +i2, i3) = aimag(fft_input(n1/2 +i1, n2/2 +i2, i3))
        enddo
      enddo
      do i2 = 0, n2/2 -1
        do i3 = -n3/2, -1
        ...
        enddo
        do i3 = 0, n3/2 -1
          fft_a(2*(i1), i2, i3) = real(fft_input(n1/2 +i1, n2/2 +i2, i3))
          fft_a(2*(i1) +1, i2, i3) = aimag(fft_input(n1/2 +i1, n2/2 +i2, i3))
        enddo
      enddo
    enddo
  endif
  if(type == -1) then
    do i1 = -n1/2, n1/2 -1
      do i2 = -n2/2, n2/2 -1
        do i3 = -n3/2, n3/2 -1
          fft_a(2*(n1/2 +i1), n2/2 +i2, n3/2 +i3) = real(fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3))
          fft_a(2*(n1/2 +i1) +1, n2/2 +i2, n3/2 +i3) = aimag(fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3))
        enddo
      enddo
    enddo
  endif
  call cdft2d(2*n1, n2, 2*n1, n2, n3, type, fft_a, fft_t, fft_ip, fft_w)
  if(type == +1) then
    do i1 = -n1/2, n1/2 -1
      do i2 = -n2/2, n2/2 -1
        fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
          = cmplx(fft_a(2*(n1/2 +i1), n2/2 +i2, n3/2 +i3), fft_a(2*(n1/2 +i1) +1, n2/2 +i2, n3/2 +i3), kind = 8)
      enddo
    enddo
  endif
  if(type == -1) then
    do i1 = -n1/2, -1
      do i2 = -n2/2, -1
        do i3 = -n3/2, -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(n1 +i1), n2 +i2, n3 +i3), fft_a(2*(n1 +i1) +1, n2 +i2, n3 +i3), kind = 8)
        enddo
        do i3 = 0, n3/2 -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(n1 +i1), n2 +i2, i3), fft_a(2*(n1 +i1) +1, n2 +i2, i3), kind = 8)
        enddo
      enddo
      do i2 = 0, n2/2 -1
        do i3 = -n3/2, -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(n1 +i1), i2, n3 +i3), fft_a(2*(n1 +i1) +1, i2, n3 +i3), kind = 8)
        enddo
        do i3 = 0, n3/2 -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
          = cmplx(fft_a(2*(n1 +i1), i2, i3), fft_a(2*(n1 +i1) +1, i2, i3), kind = 8)
        enddo
      enddo
    enddo
    do i1 = 0, n1/2 -1
      do i2 = -n2/2, -1
        do i3 = -n3/2, -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(i1), n2 +i2, n3 +i3), fft_a(2*(i1) +1, n2 +i2, n3 +i3), kind = 8)
        enddo
        do i3 = 0, n3/2 -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(i1), n2 +i2, i3), fft_a(2*(i1) +1, n2 +i2, i3), kind = 8)
        enddo
      enddo
      do i2 = 0, n2/2 -1
        do i3 = -n3/2, -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(i1), i2, n3 +i3), fft_a(2*(i1) +1, i2, n3 +i3), kind = 8)
        enddo
        do i3 = 0, n3/2 -1
          fft_input(n1/2 +i1, n2/2 +i2, n3/2 +i3) &
            = cmplx(fft_a(2*(i1), i2, i3), fft_a(2*(i1) +1, i2, i3), kind = 8)
        enddo
      enddo
    enddo
  endif
  fft_input(:, :, :) = fft_input(:, :, :)/dble(n1*n2*n3)**0.5d0
...
!
!
      subroutine cdft3d(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, isgn, ip(0 : *), n
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      n = 2 * max(n2, n3)
      n = max(n, n1)
      if (n .gt. 4 * ip(0)) then
          call makewt(n / 4, ip, w)
      end if
      call xdft3da_sub(n1max, n2max, n1, n2, n3, 0, isgn, a, t, ip, w)
      call cdft3db_sub(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      end
!
      subroutine rdft3d(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, isgn, ip(0 : *), n, nw, nc
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      n = 2 * max(n2, n3)
      n = max(n, n1)
      nw = ip(0)
      ...
      if (isgn .lt. 0) then
          ...
          call cdft3db_sub(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
          call xdft3da_sub(n1max, n2max, n1, n2, n3, 1, isgn, a, t, ip, w)
      else
          call xdft3da_sub(n1max, n2max, n1, n2, n3, 1, isgn, a, t, ip, w)
          call cdft3db_sub(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
          call rdft3d_sub(n1max, n2max, n1, n2, n3, isgn, a)
...
!
      subroutine ddct3d(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, isgn, ip(0 : *), n, nw, nc
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      n = max(n2, n3)
      n = max(n, n1)
      ...
      call ddxt3da_sub(n1max, n2max, n1, n2, n3, 0, isgn, a, t, ip, w)
      call ddxt3db_sub(n1max, n2max, n1, n2, n3, 0, isgn, a, t, ip, w)
      end
!
      subroutine ddst3d(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, isgn, ip(0 : *), n, nw, nc
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      n = max(n2, n3)
      n = max(n, n1)
      ...
      call ddxt3da_sub(n1max, n2max, n1, n2, n3, 1, isgn, a, t, ip, w)
      call ddxt3db_sub(n1max, n2max, n1, n2, n3, 1, isgn, a, t, ip, w)
      end
!
! -------- child routines --------
!
      subroutine xdft3da_sub(n1max, n2max, n1, n2, n3, icr, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, icr, isgn, ip(0 : *), i, j, k
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      do k = 0, n3 - 1
          if (icr .eq. 0) then
              do j = 0, n2 - 1
...
!
      subroutine cdft3db_sub(n1max, n2max, n1, n2, n3, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, isgn, ip(0 : *), i, j, k
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      if (n1 .gt. 4) then
          do j = 0, n2 - 1
              do i = 0, n1 - 8, 8
...
!
      ...
      integer n1max, n2max, n1, n2, n3, isgn, n2h, n3h, i, j, k, l
...
!
      subroutine ddxt3da_sub(n1max, n2max, n1, n2, n3, ics, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, ics, isgn, ip(0 : *), i, j, k
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      do k = 0, n3 - 1
          if (ics .eq. 0) then
              do j = 0, n2 - 1
...
!
      subroutine ddxt3db_sub(n1max, n2max, n1, n2, n3, ics, isgn, a, t, ip, w)
      integer n1max, n2max, n1, n2, n3, ics, isgn, ip(0 : *), i, j, k
      real*8 a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), t(0 : *), w(0 : *)
      if (n1 .gt. 2) then
          do j = 0, n2 - 1
